...
sub test_mkrel {
  ...
  my $rel = new Foswiki::Plugins::FormQueryPlugin::Relation("Son%Ax%B is Father%A");
...
sub test_kids {
  ...
  my $rel = new Foswiki::Plugins::FormQueryPlugin::Relation("Daughter%Aof%B Mummy Mother%B");
